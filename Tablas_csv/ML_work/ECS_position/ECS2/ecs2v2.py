...
for i in lines:
        my_list = i.split(',')
        fech = my_list[1].strip()
        hr = my_list[2].strip()
        dt = my_list[3].strip()
        azp= my_list[4].strip()
        topshut = my_list[5].strip()
        botshut = my_list[6].strip()
        event = my_list[7].strip()
        wvent = my_list[8].strip()
        p2 = my_list[9].strip()
        wd = my_list[10].strip()
        print('wd:',wd)
        wdir = my_list[11].strip()
