...
# Leer el archivo CSV
file_path = 'tabla_wind20_fin3.csv'  # Reemplaza con la ruta correcta de tu archivo
...
while start_time < df['timestamp'].max():
    ...
    if not df_interval.empty:
        ...
        new_row = {
            'date': df_interval.iloc[0]['date'],  # Columna A (o cualquier otra columna que desees mantener)
...
output_file = 'p2mean_timestamp_1.csv'  # Reemplaza con la ruta deseada para guardar el archivo
