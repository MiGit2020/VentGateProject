...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 30 16:14:52 2024
lee archivo tabla_eastvent_westvent.csv y remplaza los valores en -0.1 con el promedio de los valores positivos
y ceros contiguos.
...
#eastVent_pos,westvent_pos
df = pd.read_csv('tabla_eastvent_westvent.csv')
...
df.to_csv('tabla_westvent_windDir.csv', index=False)